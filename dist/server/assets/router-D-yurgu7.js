import { r as reactExports, L as jsxRuntimeExports, M as twMerge, j as clsx, S as Slot, N as cva, O as Root, P as Image, Q as Fallback, T as Portal, U as Content2, V as Provider, W as Root3, X as Trigger, Y as createRootRouteWithContext, Z as captureException, $ as useRouter, a0 as Link, a1 as QueryClientProvider, a2 as Outlet, a3 as HeadContent, a4 as Scripts, a5 as createFileRoute, a6 as lazyRouteComponent, a7 as QueryClient, a8 as createRouter } from "./vendor-CirzapkX.js";
import { c as createClient } from "./supabase-nLbZArmc.js";
...
const $$splitComponentImporter$d = () => import("./terms-BHs35dcq.js");
...
const $$splitComponentImporter$c = () => import("./register-DPuFHIeF.js");
const Route$p = createFileRoute("/register")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./rates-C4-tuiwn.js");
...
const $$splitComponentImporter$a = () => import("./privacy-CtSnYvO3.js");
...
const $$splitComponentImporter$9 = () => import("./partner-ISO8zcJp.js");
...
const $$splitComponentImporter$8 = () => import("./my-bookings-hxon-uY9.js");
const Route$l = createFileRoute("/my-bookings")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./login-B-4oXkzh.js");
const Route$k = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./impact-DVPisM3P.js");
...
const $$splitComponentImporter$5 = () => import("./faq-C4T96eFt.js");
...
const $$splitComponentImporter$4 = () => import("./contact-DWmn17vA.js");
...
const $$splitComponentImporter$3 = () => import("./careers-CJZGidQV.js");
...
const $$splitComponentImporter$2 = () => import("./blog-C0YWForG.js");
...
const $$splitComponentImporter$1 = () => import("./about-DtK-79UT.js");
...
const $$splitComponentImporter = () => import("./index-Dl7EvraH.js");
...
const AdminIndexRoute = Route$c.update({
  ...
  path: "/admin/",
  getParentRoute: () => Route$r
}).lazy(() => import("./index.lazy-B-B4UjY2.js").then((d) => d.Route));
const AdminUsersRoute = Route$b.update({
  id: "/admin/users",
  path: "/admin/users",
  getParentRoute: () => Route$r
}).lazy(() => import("./users.lazy-hl58g_EC.js").then((d) => d.Route));
const AdminErpRoute = Route$a.update({
  id: "/admin/erp",
  path: "/admin/erp",
  getParentRoute: () => Route$r
}).lazy(() => import("./erp.lazy-DL-kHxp7.js").then((d) => d.Route));
const AdminCategoriesRoute = Route$9.update({
  id: "/admin/categories",
  path: "/admin/categories",
  getParentRoute: () => Route$r
}).lazy(
  () => import("./categories.lazy-DU8mg6-I.js").then((d) => d.Route)
);
const AdminBookingsRoute = Route$8.update({
  ...
  () => import("./bookings.lazy-CyvfAo8n.js").then((d) => d.Route)
);
const AdminErpIndexRoute = Route$7.update({
  ...
  () => import("./index.lazy-D75wT8Qk.js").then((d) => d.Route)
);
const AdminErpWhatsappRoute = Route$6.update({
  ...
  () => import("./whatsapp.lazy-DfxFtrbn.js").then((d) => d.Route)
);
const AdminErpTransactionsRoute = Route$5.update({
  ...
  () => import("./transactions.lazy-CLWCjHtm.js").then((d) => d.Route)
);
const AdminErpSuppliersRoute = Route$4.update({
  ...
  () => import("./suppliers.lazy-e88tgExb.js").then((d) => d.Route)
);
const AdminErpReceiptsRoute = Route$3.update({
  ...
  () => import("./receipts.lazy-cc5Ps_vQ.js").then((d) => d.Route)
);
const AdminErpMaterialsRoute = Route$2.update({
  ...
  () => import("./materials.lazy-C0l1U3q9.js").then((d) => d.Route)
);
const AdminErpInvoicesRoute = Route$1.update({
  ...
  () => import("./invoices.lazy-ByqNu31a.js").then((d) => d.Route)
);
const AdminErpCustomersRoute = Route.update({
  ...
  () => import("./customers.lazy-CYszTQVF.js").then((d) => d.Route)
);
