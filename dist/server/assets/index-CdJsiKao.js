import { V as React, S as getDefaultExportFromCjs, r as reactExports, W as jsxRuntimeExports } from "./server-B0dJkL-4.js";
import { c as createLucideIcon, y as clsx, u as useAuth } from "./router-6jpN8mQG.js";
import { a as fetchERPDashboard } from "./api-CHfPu43u.js";
import { S as Skeleton } from "./skeleton-EqcnD-ZK.js";
import { B as Badge } from "./badge-UvN_VHvW.js";
import { T as TrendingUp } from "./trending-up-B-K29kWb.js";
...
import { f as filterProps, r as require_baseExtremum, b as require_baseGt, c as require_baseIteratee, d as require_baseLt, i as isFunction, e as Text, p as polarToCartesian, L as Layer, g as getTickClassName, h as adaptEventsOfChild, j as Label, D as Dot, k as Curve, l as isNil, m as getValueByDataKey, S as Shape, A as Animate, n as get, o as interpolateNumber, q as isEqual, s as isNumber, t as LabelList, u as uniqueId, G as Global, v as mathSign, w as findAllByType, x as Cell, y as getMaxRadius, z as getPercentValue, E as warn, F as generateCategoricalChart, H as formatAxisMap, R as ResponsiveContainer, B as BarChart, C as CartesianGrid, X as XAxis, Y as YAxis, T as Tooltip, a as Bar } from "./BarChart-Cg8-s9Qm.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border/60 bg-card p-5 shadow-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[180px] w-full relative", children: top_materials.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center text-xs text-muted-foreground", children: "No collection records this month" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Pie, { data: top_materials, dataKey: "revenue", nameKey: "name", cx: "50%", cy: "50%", outerRadius: 70, label: ({
            name
          }) => name, children: top_materials.map((entry, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: entry.color_hex || CHART_COLORS[index % CHART_COLORS.length] }, `cell-${index}`)) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 space-y-1.5", children: top_materials.map((m, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-2.5 w-2.5 rounded-full", style: {
              backgroundColor: m.color_hex || CHART_COLORS[i % CHART_COLORS.length]
            } }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { className: "divide-y divide-border", children: [
            recent_transactions.slice(0, 5).map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: `rounded-full text-[10px] px-2 py-0.5 ${INVOICE_STATUS_COLORS[t.invoice_status] || "bg-gray-100"}`, children: t.invoice_status.toUpperCase() }) })
            ] }, t.id)),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border/60 bg-card p-5 shadow-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 max-h-[250px] overflow-y-auto pr-1", children: [
          low_stock_alerts.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 border-b border-border/40 pb-3 last:border-0 last:pb-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1.5 w-full bg-muted rounded-full overflow-hidden mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full bg-red-500 rounded-full", style: {
              width: `${Math.min(100, m.stock_qty / (m.min_threshold || 1) * 100)}%`
            } }) })
          ] }, m.id)),
