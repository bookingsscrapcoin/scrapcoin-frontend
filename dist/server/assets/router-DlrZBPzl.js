import { r as reactExports, L as jsxRuntimeExports, M as twMerge, j as clsx, S as Slot, N as cva, O as Root, P as Image, Q as Fallback, T as Portal, U as Content2, V as Provider, W as Root3, X as Trigger, Y as createRootRouteWithContext, Z as captureException, $ as useRouter, a0 as Link, a1 as QueryClientProvider, a2 as Outlet, a3 as HeadContent, a4 as Scripts, a5 as createFileRoute, a6 as lazyRouteComponent, a7 as QueryClient, a8 as createRouter } from "./vendor-Cr71NyXt.js";
import { c as createClient } from "./supabase-BrXMAcaQ.js";
...
const appCss = "/assets/styles-qJt8qVn5.css";
function cn(...inputs) {
...
const $$splitComponentImporter$d = () => import("./terms-R7UTGhu9.js");
...
const $$splitComponentImporter$c = () => import("./register-jZJI9YV_.js");
const Route$p = createFileRoute("/register")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./rates-KEIPTo1Z.js");
...
const $$splitComponentImporter$a = () => import("./privacy-Ece4k0K8.js");
...
const $$splitComponentImporter$9 = () => import("./partner-CbK2DtdQ.js");
...
const $$splitComponentImporter$8 = () => import("./my-bookings-B3e14Pex.js");
const Route$l = createFileRoute("/my-bookings")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./login-CUhltiOs.js");
const Route$k = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./impact-DnzsHx_N.js");
...
const $$splitComponentImporter$5 = () => import("./faq-ebP0if5E.js");
...
const $$splitComponentImporter$4 = () => import("./contact-CgCjhE98.js");
...
const $$splitComponentImporter$3 = () => import("./careers-BNefNgn5.js");
...
const $$splitComponentImporter$2 = () => import("./blog-CjFZ9209.js");
...
const $$splitComponentImporter$1 = () => import("./about-73uMRF1N.js");
...
const $$splitComponentImporter = () => import("./index-DYB_cZOj.js");
...
const AdminIndexRoute = Route$c.update({
  ...
  path: "/admin/",
  getParentRoute: () => Route$r
}).lazy(() => import("./index.lazy-CCDyngvC.js").then((d) => d.Route));
const AdminUsersRoute = Route$b.update({
  id: "/admin/users",
  path: "/admin/users",
  getParentRoute: () => Route$r
}).lazy(() => import("./users.lazy-BBNpY88K.js").then((d) => d.Route));
const AdminErpRoute = Route$a.update({
  id: "/admin/erp",
  path: "/admin/erp",
  getParentRoute: () => Route$r
}).lazy(() => import("./erp.lazy-D3s2hWIZ.js").then((d) => d.Route));
const AdminCategoriesRoute = Route$9.update({
  id: "/admin/categories",
  path: "/admin/categories",
  getParentRoute: () => Route$r
}).lazy(
  () => import("./categories.lazy-DoKalVNZ.js").then((d) => d.Route)
);
const AdminBookingsRoute = Route$8.update({
  ...
  () => import("./bookings.lazy-DFCBR1Lm.js").then((d) => d.Route)
);
const AdminErpIndexRoute = Route$7.update({
  ...
  () => import("./index.lazy-C7nqMDEq.js").then((d) => d.Route)
);
const AdminErpWhatsappRoute = Route$6.update({
  ...
  () => import("./whatsapp.lazy-PugiqAf4.js").then((d) => d.Route)
);
const AdminErpTransactionsRoute = Route$5.update({
  ...
  () => import("./transactions.lazy-CmS-C1T2.js").then((d) => d.Route)
);
const AdminErpSuppliersRoute = Route$4.update({
  ...
  () => import("./suppliers.lazy-B20d8vnF.js").then((d) => d.Route)
);
const AdminErpReceiptsRoute = Route$3.update({
  ...
  () => import("./receipts.lazy-D35T65rs.js").then((d) => d.Route)
);
const AdminErpMaterialsRoute = Route$2.update({
  ...
  () => import("./materials.lazy-BUqpaVde.js").then((d) => d.Route)
);
const AdminErpInvoicesRoute = Route$1.update({
  ...
  () => import("./invoices.lazy-CQXIyqiX.js").then((d) => d.Route)
);
const AdminErpCustomersRoute = Route.update({
  ...
  () => import("./customers.lazy-Cj1NCtOo.js").then((d) => d.Route)
);
