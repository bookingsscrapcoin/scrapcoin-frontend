import { r as reactExports, L as jsxRuntimeExports, M as twMerge, j as clsx, S as Slot, N as cva, O as Root, P as Image, Q as Fallback, T as Portal, U as Content2, V as Provider, W as Root3, X as Trigger, Y as createRootRouteWithContext, Z as captureException, $ as useRouter, a0 as Link, a1 as QueryClientProvider, a2 as Outlet, a3 as HeadContent, a4 as Scripts, a5 as createFileRoute, a6 as lazyRouteComponent, a7 as QueryClient, a8 as createRouter } from "./vendor-CEtpOJd4.js";
import { c as createClient } from "./supabase-J6qMCcZY.js";
...
const $$splitComponentImporter$d = () => import("./terms-BgcolhI0.js");
...
const $$splitComponentImporter$c = () => import("./register-w7QIo5p5.js");
const Route$p = createFileRoute("/register")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./rates-DvLag5Pi.js");
...
const $$splitComponentImporter$a = () => import("./privacy-rqXJf2AF.js");
...
const $$splitComponentImporter$9 = () => import("./partner-B-tCBkHB.js");
...
const $$splitComponentImporter$8 = () => import("./my-bookings-C7DGeVpc.js");
const Route$l = createFileRoute("/my-bookings")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./login-jbLC3D3Q.js");
const Route$k = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./impact-DqjtW7dG.js");
...
const $$splitComponentImporter$5 = () => import("./faq-qN6lkz5T.js");
...
const $$splitComponentImporter$4 = () => import("./contact-CpcEAOsd.js");
...
const $$splitComponentImporter$3 = () => import("./careers-B7jZl46e.js");
...
const $$splitComponentImporter$2 = () => import("./blog-BQobeoER.js");
...
const $$splitComponentImporter$1 = () => import("./about-BIfNdLzD.js");
...
const $$splitComponentImporter = () => import("./index-DdOTIRlE.js");
...
const AdminIndexRoute = Route$c.update({
  ...
  path: "/admin/",
  getParentRoute: () => Route$r
}).lazy(() => import("./index.lazy-nphf-oMR.js").then((d) => d.Route));
const AdminUsersRoute = Route$b.update({
  id: "/admin/users",
  path: "/admin/users",
  getParentRoute: () => Route$r
}).lazy(() => import("./users.lazy-BRBfgYzf.js").then((d) => d.Route));
const AdminErpRoute = Route$a.update({
  id: "/admin/erp",
  path: "/admin/erp",
  getParentRoute: () => Route$r
}).lazy(() => import("./erp.lazy-CabVxr-B.js").then((d) => d.Route));
const AdminCategoriesRoute = Route$9.update({
  id: "/admin/categories",
  path: "/admin/categories",
  getParentRoute: () => Route$r
}).lazy(
  () => import("./categories.lazy-B9MTjJzb.js").then((d) => d.Route)
);
const AdminBookingsRoute = Route$8.update({
  ...
  () => import("./bookings.lazy-BmoQggxB.js").then((d) => d.Route)
);
const AdminErpIndexRoute = Route$7.update({
  ...
  () => import("./index.lazy-DHEJDwjT.js").then((d) => d.Route)
);
const AdminErpWhatsappRoute = Route$6.update({
  ...
  () => import("./whatsapp.lazy-ozfsARF4.js").then((d) => d.Route)
);
const AdminErpTransactionsRoute = Route$5.update({
  ...
  () => import("./transactions.lazy-CmSmF96k.js").then((d) => d.Route)
);
const AdminErpSuppliersRoute = Route$4.update({
  ...
  () => import("./suppliers.lazy-IjBRR9l7.js").then((d) => d.Route)
);
const AdminErpReceiptsRoute = Route$3.update({
  ...
  () => import("./receipts.lazy-BLB6RcCx.js").then((d) => d.Route)
);
const AdminErpMaterialsRoute = Route$2.update({
  ...
  () => import("./materials.lazy-BZZnNu6P.js").then((d) => d.Route)
);
const AdminErpInvoicesRoute = Route$1.update({
  ...
  () => import("./invoices.lazy-CcymTDXc.js").then((d) => d.Route)
);
const AdminErpCustomersRoute = Route.update({
  ...
  () => import("./customers.lazy-Doa8suXG.js").then((d) => d.Route)
);
