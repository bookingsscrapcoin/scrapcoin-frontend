...
import { c as createLucideIcon, u as useAuth, t as toast, B as Button } from "./router-6jpN8mQG.js";
import { d as fetchERPMaterials, m as fetchERPCustomers, n as fetchERPPurchaseReceipts, o as deleteERPPurchaseReceipt, p as createERPPurchaseReceipt } from "./api-CHfPu43u.js";
...
function ERPReceiptsPage() {
  ...
  const filtered = receipts.filter((r) => r.receipt_number.toLowerCase().includes(search.toLowerCase()) || r.customer_name.toLowerCase().includes(search.toLowerCase()) || r.material_name.toLowerCase().includes(search.toLowerCase()));
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3 items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full sm:max-w-xs", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Search receipt list...", value: search, onChange: (e) => setSearch(e.target.value), className: "pl-9 rounded-xl border border-border bg-card text-xs" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 w-full sm:w-auto justify-end items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", size: "sm", onClick: loadReceipts, disabled: loading, className: "rounded-xl cursor-pointer", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCw, { className: `h-3.5 w-3.5 ${loading ? "animate-spin" : ""}` }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { className: "divide-y divide-border", children: [
        filtered.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-muted/10 transition-colors", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4 text-right whitespace-nowrap", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-end gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", onClick: () => generateReceiptPDF(r), className: "h-7 w-7 rounded-lg text-muted-foreground hover:text-foreground cursor-pointer", title: "Print Receipt", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Printer, { className: "h-4 w-4" }) }),
            isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", onClick: () => handleDelete(r.id), className: "h-7 w-7 rounded-lg text-red-500 hover:text-red-600 hover:bg-red-50 cursor-pointer", title: "Delete Scale Receipt", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-4 w-4" }) })
          ] }) })
        ] }, r.id)),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: dialogOpen, onOpenChange: setDialogOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-md bg-card rounded-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "text-base font-bold text-foreground flex items-center gap-2", children: [
        ...
        " Log B2C Scale Collection Receipt"
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "rec-cust", children: "Household Customer (Optional)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { id: "rec-cust", value: customerId, onChange: (e) => setCustomerId(e.target.value), className: "w-full rounded-xl border border-border bg-background px-3 py-2.5 text-xs font-medium focus:outline-none focus:ring-1 focus:ring-primary", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "rec-material", children: "Material Collected" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { id: "rec-material", value: materialId, onChange: (e) => setMaterialId(e.target.value), required: true, className: "w-full rounded-xl border border-border bg-background px-3 py-2.5 text-xs font-medium focus:outline-none focus:ring-1 focus:ring-primary", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "rec-weight", children: "Collected Weight (kg)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "rec-weight", type: "number", step: "0.001", value: weight, onChange: (e) => setWeight(e.target.value !== "" ? Number(e.target.value) : ""), placeholder: "0.000", required: true, className: "rounded-xl border border-border" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "rec-price", children: "Buying Rate (₹/kg)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "rec-price", type: "number", step: "0.01", value: price, onChange: (e) => setPrice(e.target.value !== "" ? Number(e.target.value) : ""), placeholder: "₹ 0.00", required: true, className: "rounded-xl border border-border" })
          ] })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", children: ["cash", "upi", "bank_transfer"].map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", variant: payMethod === m ? "default" : "outline", size: "sm", onClick: () => setPayMethod(m), className: "rounded-xl text-[10px] uppercase font-bold cursor-pointer", children: m.replace("_", " ") }, m)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "rec-notes", children: "Remarks / Notes" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "rec-notes", value: notes, onChange: (e) => setNotes(e.target.value), placeholder: "Scale number, vehicle details...", className: "rounded-xl border border-border" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "pt-2 border-t border-border/40", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "submit", disabled: submitting, className: "rounded-xl cursor-pointer", children: submitting ? "Saving Receipt..." : "Record Scale Collection" })
        ] })
      ] })
    ] }) })
  ] });
