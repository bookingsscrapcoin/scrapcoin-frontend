...
import { u as useAuth, a as useNavigate, B as Button, t as toast } from "./router-6jpN8mQG.js";
import { A as AdminLayout, S as Sheet, a as SheetContent, b as SheetHeader, c as SheetTitle } from "./AdminLayout-BISCO49U.js";
...
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-C4TpbvrP.js";
...
import "./users-D3jSWBvA.js";
import "./package-BTjK5Aoa.js";
import "./index-BEZ-KfWi.js";
import "./chevron-down-DO9RxJ5M.js";
import "./chevron-up-DSsiWMFD.js";
const STATUS_CONFIG = {
  scheduled: {
    label: "Scheduled",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AdminLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3 flex-wrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Search by name or phone...", value: search, onChange: (e) => setSearch(e.target.value), className: "max-w-xs" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap", children: FILTERS.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: filter === f ? "default" : "outline", className: "rounded-full capitalize text-xs", onClick: () => setFilter(f), children: f.replace("_", " ") }, f)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-border/60 bg-card overflow-hidden", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-5 space-y-3", children: [1, 2, 3, 4, 5].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-10 w-full" }, i)) }) : filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-10 text-center text-sm text-muted-foreground", children: "No bookings found." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border", children: filtered.map((b) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { onClick: () => setSelected(b), className: "cursor-pointer hover:bg-muted/30 transition-colors", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: `rounded-full text-xs ${s.className}`, children: s.label }) })
          ] }, b.id);
        }) })
      ] }) }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Sheet, { open: !!selected, onOpenChange: (o) => {
      if (!o) {
        setSelected(null);
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 space-y-4 text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 mt-1", children: selected.materials.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full border border-border bg-muted px-2.5 py-0.5 text-xs", children: m }, m)) })
          ] })
        ] }),
        !showWeightForm && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-4 border-t border-border", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: selected.status, onValueChange: (val) => {
            if (val === "completed") {
              const initial = {};
          ...
          }, disabled: updating || profile?.role === "champion" && selected.status === "completed", children: [
        ...
        !showWeightForm && /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: profile?.role === "admin" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-4 border-t border-border", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: selected.championId ?? "unassigned", onValueChange: (val) => {
        ...
        showWeightForm && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 pt-4 border-t border-border", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: selected.materials.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: `weight-${m}`, type: "number", step: "any", placeholder: "0.0", value: weightsForm[m] ?? "", onChange: (e) => setWeightsForm((prev) => ({
              ...prev,
              [m]: e.target.value
            })), className: "rounded-xl", required: true })
          ] }, m)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", className: "w-full rounded-xl cursor-pointer", onClick: () => setShowWeightForm(false), children: "Cancel" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", className: "w-full rounded-xl cursor-pointer", disabled: updating, onClick: async () => {
