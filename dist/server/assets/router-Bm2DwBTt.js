import { r as reactExports, L as jsxRuntimeExports, M as twMerge, j as clsx, S as Slot, N as cva, O as Root, P as Image, Q as Fallback, T as Portal, U as Content2, V as Provider, W as Root3, X as Trigger, Y as createRootRouteWithContext, Z as captureException, $ as useRouter, a0 as Link, a1 as QueryClientProvider, a2 as Outlet, a3 as HeadContent, a4 as Scripts, a5 as createFileRoute, a6 as lazyRouteComponent, a7 as QueryClient, a8 as createRouter } from "./vendor-2vo6rCki.js";
import { c as createClient } from "./supabase-6bXjhJLX.js";
...
const $$splitComponentImporter$d = () => import("./terms-DFHjQ44K.js");
...
const $$splitComponentImporter$c = () => import("./register-CyIjMflj.js");
const Route$p = createFileRoute("/register")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./rates-DGGfSuzh.js");
...
const $$splitComponentImporter$a = () => import("./privacy-Ca2l1uJD.js");
...
const $$splitComponentImporter$9 = () => import("./partner-Dc5mtzlf.js");
...
const $$splitComponentImporter$8 = () => import("./my-bookings-BWlJHs_Z.js");
const Route$l = createFileRoute("/my-bookings")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./login-CrkR5vkY.js");
const Route$k = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./impact-CW2yhJ66.js");
...
const $$splitComponentImporter$5 = () => import("./faq-bJ8pKfYm.js");
...
const $$splitComponentImporter$4 = () => import("./contact-BaGd-5rw.js");
...
const $$splitComponentImporter$3 = () => import("./careers-ClqryHdg.js");
...
const $$splitComponentImporter$2 = () => import("./blog-B8dOq79-.js");
...
const $$splitComponentImporter$1 = () => import("./about-CcVin3r4.js");
...
const $$splitComponentImporter = () => import("./index-C21JKZtV.js");
...
const AdminIndexRoute = Route$c.update({
  ...
  path: "/admin/",
  getParentRoute: () => Route$r
}).lazy(() => import("./index.lazy-PaIy4OJ9.js").then((d) => d.Route));
const AdminUsersRoute = Route$b.update({
  id: "/admin/users",
  path: "/admin/users",
  getParentRoute: () => Route$r
}).lazy(() => import("./users.lazy-DB5uC4ni.js").then((d) => d.Route));
const AdminErpRoute = Route$a.update({
  id: "/admin/erp",
  path: "/admin/erp",
  getParentRoute: () => Route$r
}).lazy(() => import("./erp.lazy-qdSbfpLy.js").then((d) => d.Route));
const AdminCategoriesRoute = Route$9.update({
  id: "/admin/categories",
  path: "/admin/categories",
  getParentRoute: () => Route$r
}).lazy(
  () => import("./categories.lazy-Bqfry0qP.js").then((d) => d.Route)
);
const AdminBookingsRoute = Route$8.update({
  ...
  () => import("./bookings.lazy-nBVBOWAw.js").then((d) => d.Route)
);
const AdminErpIndexRoute = Route$7.update({
  ...
  () => import("./index.lazy-CbLseqbm.js").then((d) => d.Route)
);
const AdminErpWhatsappRoute = Route$6.update({
  ...
  () => import("./whatsapp.lazy-B3tHeLTO.js").then((d) => d.Route)
);
const AdminErpTransactionsRoute = Route$5.update({
  ...
  () => import("./transactions.lazy-CQDDCXsU.js").then((d) => d.Route)
);
const AdminErpSuppliersRoute = Route$4.update({
  ...
  () => import("./suppliers.lazy-CyIhGOj9.js").then((d) => d.Route)
);
const AdminErpReceiptsRoute = Route$3.update({
  ...
  () => import("./receipts.lazy-9T6vBavR.js").then((d) => d.Route)
);
const AdminErpMaterialsRoute = Route$2.update({
  ...
  () => import("./materials.lazy-DKhT_5pg.js").then((d) => d.Route)
);
const AdminErpInvoicesRoute = Route$1.update({
  ...
  () => import("./invoices.lazy-DGu7Q3XB.js").then((d) => d.Route)
);
const AdminErpCustomersRoute = Route.update({
  ...
  () => import("./customers.lazy-DlqjfzYX.js").then((d) => d.Route)
);
