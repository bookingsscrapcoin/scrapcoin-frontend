import { r as reactExports, L as jsxRuntimeExports, M as twMerge, j as clsx, S as Slot, N as cva, O as Root, P as Image, Q as Fallback, T as Portal, U as Content2, V as Provider, W as Root3, X as Trigger, Y as createRootRouteWithContext, Z as captureException, $ as useRouter, a0 as Link, a1 as QueryClientProvider, a2 as Outlet, a3 as HeadContent, a4 as Scripts, a5 as createFileRoute, a6 as lazyRouteComponent, a7 as QueryClient, a8 as createRouter } from "./vendor-D6Rg8XTl.js";
import { c as createClient } from "./supabase-BTFOxJMB.js";
...
const $$splitComponentImporter$d = () => import("./terms-Z4zra1pt.js");
...
const $$splitComponentImporter$c = () => import("./register-Dg-c--J7.js");
const Route$p = createFileRoute("/register")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./rates-BdigZpWU.js");
...
const $$splitComponentImporter$a = () => import("./privacy-DMAB_q3r.js");
...
const $$splitComponentImporter$9 = () => import("./partner-dLjAp06y.js");
...
const $$splitComponentImporter$8 = () => import("./my-bookings-yO5jmjxN.js");
const Route$l = createFileRoute("/my-bookings")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./login-C1WLFV3C.js");
const Route$k = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./impact-CL9fp7ln.js");
...
const $$splitComponentImporter$5 = () => import("./faq-DufHtEIF.js");
...
const $$splitComponentImporter$4 = () => import("./contact-DhvUJcaC.js");
...
const $$splitComponentImporter$3 = () => import("./careers-BHn8Q2OP.js");
...
const $$splitComponentImporter$2 = () => import("./blog-CT39t81B.js");
...
const $$splitComponentImporter$1 = () => import("./about-BDKrXsbl.js");
...
const $$splitComponentImporter = () => import("./index-DrI0Tpll.js");
...
const AdminIndexRoute = Route$c.update({
  ...
  path: "/admin/",
  getParentRoute: () => Route$r
}).lazy(() => import("./index.lazy-18U0UwZi.js").then((d) => d.Route));
const AdminUsersRoute = Route$b.update({
  id: "/admin/users",
  path: "/admin/users",
  getParentRoute: () => Route$r
}).lazy(() => import("./users.lazy-DFeEVHz9.js").then((d) => d.Route));
const AdminErpRoute = Route$a.update({
  id: "/admin/erp",
  path: "/admin/erp",
  getParentRoute: () => Route$r
}).lazy(() => import("./erp.lazy-BgEdx8Mz.js").then((d) => d.Route));
const AdminCategoriesRoute = Route$9.update({
  id: "/admin/categories",
  path: "/admin/categories",
  getParentRoute: () => Route$r
}).lazy(
  () => import("./categories.lazy-CoCfDVb5.js").then((d) => d.Route)
);
const AdminBookingsRoute = Route$8.update({
  ...
  () => import("./bookings.lazy-DOOT7CHb.js").then((d) => d.Route)
);
const AdminErpIndexRoute = Route$7.update({
  ...
  () => import("./index.lazy-0Y3WHEGC.js").then((d) => d.Route)
);
const AdminErpWhatsappRoute = Route$6.update({
  ...
  () => import("./whatsapp.lazy-CNa-TJfS.js").then((d) => d.Route)
);
const AdminErpTransactionsRoute = Route$5.update({
  ...
  () => import("./transactions.lazy-2mNs7e5k.js").then((d) => d.Route)
);
const AdminErpSuppliersRoute = Route$4.update({
  ...
  () => import("./suppliers.lazy-FuBfmGfn.js").then((d) => d.Route)
);
const AdminErpReceiptsRoute = Route$3.update({
  ...
  () => import("./receipts.lazy-C4mnEEmE.js").then((d) => d.Route)
);
const AdminErpMaterialsRoute = Route$2.update({
  ...
  () => import("./materials.lazy-BJmhvYq8.js").then((d) => d.Route)
);
const AdminErpInvoicesRoute = Route$1.update({
  ...
  () => import("./invoices.lazy--Cexzj9_.js").then((d) => d.Route)
);
const AdminErpCustomersRoute = Route.update({
  ...
  () => import("./customers.lazy-BKP8eqzH.js").then((d) => d.Route)
);
