import { r as reactExports, L as jsxRuntimeExports, M as twMerge, j as clsx, S as Slot, N as cva, O as Root, P as Image, Q as Fallback, T as Portal, U as Content2, V as Provider, W as Root3, X as Trigger, Y as createRootRouteWithContext, Z as captureException, $ as useRouter, a0 as Link, a1 as QueryClientProvider, a2 as Outlet, a3 as HeadContent, a4 as Scripts, a5 as createFileRoute, a6 as lazyRouteComponent, a7 as QueryClient, a8 as createRouter } from "./vendor-LwMzV_Ui.js";
import { c as createClient } from "./supabase-BCGlR59b.js";
...
const $$splitComponentImporter$d = () => import("./terms-BalqFcZZ.js");
...
const $$splitComponentImporter$c = () => import("./register-CHfBHyhd.js");
const Route$p = createFileRoute("/register")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./rates-BMVJpH6K.js");
...
const $$splitComponentImporter$a = () => import("./privacy-BCI4tZXe.js");
...
const $$splitComponentImporter$9 = () => import("./partner-aUmQg8ik.js");
...
const $$splitComponentImporter$8 = () => import("./my-bookings-OUb6Aid5.js");
const Route$l = createFileRoute("/my-bookings")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./login-D6WYmZpi.js");
const Route$k = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./impact-B4SlVjgy.js");
...
const $$splitComponentImporter$5 = () => import("./faq-DiQeeMch.js");
...
const $$splitComponentImporter$4 = () => import("./contact-D9Qu3CH3.js");
...
const $$splitComponentImporter$3 = () => import("./careers-874cK8vc.js");
...
const $$splitComponentImporter$2 = () => import("./blog-Bhzq3_hJ.js");
...
const $$splitComponentImporter$1 = () => import("./about-G5njtY0q.js");
...
const $$splitComponentImporter = () => import("./index-IIBmQUeq.js");
...
const AdminIndexRoute = Route$c.update({
  ...
  path: "/admin/",
  getParentRoute: () => Route$r
}).lazy(() => import("./index.lazy-OQn_zxPX.js").then((d) => d.Route));
const AdminUsersRoute = Route$b.update({
  id: "/admin/users",
  path: "/admin/users",
  getParentRoute: () => Route$r
}).lazy(() => import("./users.lazy-C3khEJA9.js").then((d) => d.Route));
const AdminErpRoute = Route$a.update({
  id: "/admin/erp",
  path: "/admin/erp",
  getParentRoute: () => Route$r
}).lazy(() => import("./erp.lazy-DzSafmmC.js").then((d) => d.Route));
const AdminCategoriesRoute = Route$9.update({
  id: "/admin/categories",
  path: "/admin/categories",
  getParentRoute: () => Route$r
}).lazy(
  () => import("./categories.lazy-D-ts8n02.js").then((d) => d.Route)
);
const AdminBookingsRoute = Route$8.update({
  ...
  () => import("./bookings.lazy-CWNf23jP.js").then((d) => d.Route)
);
const AdminErpIndexRoute = Route$7.update({
  ...
  () => import("./index.lazy-BeTneBQ-.js").then((d) => d.Route)
);
const AdminErpWhatsappRoute = Route$6.update({
  ...
  () => import("./whatsapp.lazy-f51A5S6A.js").then((d) => d.Route)
);
const AdminErpTransactionsRoute = Route$5.update({
  ...
  () => import("./transactions.lazy-6LSLstI7.js").then((d) => d.Route)
);
const AdminErpSuppliersRoute = Route$4.update({
  ...
  () => import("./suppliers.lazy-BqiYVNFO.js").then((d) => d.Route)
);
const AdminErpReceiptsRoute = Route$3.update({
  ...
  () => import("./receipts.lazy-B_UCDwt9.js").then((d) => d.Route)
);
const AdminErpMaterialsRoute = Route$2.update({
  ...
  () => import("./materials.lazy-CniSLwMn.js").then((d) => d.Route)
);
const AdminErpInvoicesRoute = Route$1.update({
  ...
  () => import("./invoices.lazy-Fqn00C7w.js").then((d) => d.Route)
);
const AdminErpCustomersRoute = Route.update({
  ...
  () => import("./customers.lazy-z4F2ZggI.js").then((d) => d.Route)
);
