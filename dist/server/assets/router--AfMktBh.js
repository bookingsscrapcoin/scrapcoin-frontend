import { r as reactExports, L as jsxRuntimeExports, M as twMerge, j as clsx, S as Slot, N as cva, O as Root, P as Image, Q as Fallback, T as Portal, U as Content2, V as Provider, W as Root3, X as Trigger, Y as createRootRouteWithContext, Z as captureException, $ as useRouter, a0 as Link, a1 as QueryClientProvider, a2 as Outlet, a3 as HeadContent, a4 as Scripts, a5 as createFileRoute, a6 as lazyRouteComponent, a7 as QueryClient, a8 as createRouter } from "./vendor-OkomiPNA.js";
import { c as createClient } from "./supabase-CTZyeyMt.js";
...
const appCss = "/assets/styles-DVXg1iZ5.css";
function cn(...inputs) {
...
const $$splitComponentImporter$d = () => import("./terms-LVqPFod0.js");
...
const $$splitComponentImporter$c = () => import("./register-C1RHCxYn.js");
const Route$p = createFileRoute("/register")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./rates-ByiJP5Oi.js");
...
const $$splitComponentImporter$a = () => import("./privacy-CQ2xGOcj.js");
...
const $$splitComponentImporter$9 = () => import("./partner-CBXqpD_7.js");
...
const $$splitComponentImporter$8 = () => import("./my-bookings-CrRoTaTh.js");
const Route$l = createFileRoute("/my-bookings")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./login-Cw4zmOmQ.js");
const Route$k = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./impact-DxB1LkgV.js");
...
const $$splitComponentImporter$5 = () => import("./faq-D2hGxuer.js");
...
const $$splitComponentImporter$4 = () => import("./contact-SZtWkyPF.js");
...
const $$splitComponentImporter$3 = () => import("./careers-DVdyMNFk.js");
...
const $$splitComponentImporter$2 = () => import("./blog-mgDSZ615.js");
...
const $$splitComponentImporter$1 = () => import("./about-BQq0-2gJ.js");
...
const $$splitComponentImporter = () => import("./index-BvbrbEq6.js");
...
const AdminIndexRoute = Route$c.update({
  ...
  path: "/admin/",
  getParentRoute: () => Route$r
}).lazy(() => import("./index.lazy-CzBpAM5e.js").then((d) => d.Route));
const AdminUsersRoute = Route$b.update({
  id: "/admin/users",
  path: "/admin/users",
  getParentRoute: () => Route$r
}).lazy(() => import("./users.lazy-kYpuXnjq.js").then((d) => d.Route));
const AdminErpRoute = Route$a.update({
  id: "/admin/erp",
  path: "/admin/erp",
  getParentRoute: () => Route$r
}).lazy(() => import("./erp.lazy-CryRh4aB.js").then((d) => d.Route));
const AdminCategoriesRoute = Route$9.update({
  id: "/admin/categories",
  path: "/admin/categories",
  getParentRoute: () => Route$r
}).lazy(
  () => import("./categories.lazy-Dgj7TqEy.js").then((d) => d.Route)
);
const AdminBookingsRoute = Route$8.update({
  ...
  () => import("./bookings.lazy-BcVvI2TK.js").then((d) => d.Route)
);
const AdminErpIndexRoute = Route$7.update({
  ...
  () => import("./index.lazy-Ctmy_fcW.js").then((d) => d.Route)
);
const AdminErpWhatsappRoute = Route$6.update({
  ...
  () => import("./whatsapp.lazy-C1k4pj4k.js").then((d) => d.Route)
);
const AdminErpTransactionsRoute = Route$5.update({
  ...
  () => import("./transactions.lazy-DjPl6IQw.js").then((d) => d.Route)
);
const AdminErpSuppliersRoute = Route$4.update({
  ...
  () => import("./suppliers.lazy-29Hh3yNx.js").then((d) => d.Route)
);
const AdminErpReceiptsRoute = Route$3.update({
  ...
  () => import("./receipts.lazy-Cwjo4yyc.js").then((d) => d.Route)
);
const AdminErpMaterialsRoute = Route$2.update({
  ...
  () => import("./materials.lazy-CglJm-HD.js").then((d) => d.Route)
);
const AdminErpInvoicesRoute = Route$1.update({
  ...
  () => import("./invoices.lazy-WZ_MlQhs.js").then((d) => d.Route)
);
const AdminErpCustomersRoute = Route.update({
  ...
  () => import("./customers.lazy-DAfjvttZ.js").then((d) => d.Route)
);
