import { ab as createLazyFileRoute, r as reactExports, ae as toast, L as jsxRuntimeExports, ba as CircleCheck, bl as CreditCard, b8 as CircleAlert, bc as Search, b7 as RotateCw, bd as Download } from "./vendor-Cr71NyXt.js";
import { u as useAuth, B as Button } from "./router-DlrZBPzl.js";
import { t as fetchERPInvoices, v as payERPInvoice } from "./api-mrjOuQFH.js";
...
async function generatePDFFromInvoice(i) {
  ...
  fn(7.5);
  st(CHAR);
  doc.text(i.notes || "No custom remarks recorded.", 20, totY + 18, { width: 80 });
  sf(DARK);
