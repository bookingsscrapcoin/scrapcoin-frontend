import { r as reactExports, W as jsxRuntimeExports } from "./server-B0dJkL-4.js";
import { u as useAuth, t as toast, B as Button } from "./router-6jpN8mQG.js";
import { d as fetchERPMaterials, e as fetchERPSuppliers, g as fetchERPTransactions, s as sendERPWhatsApp, h as deleteERPTransaction, i as createERPTransaction } from "./api-CHfPu43u.js";
import { I as Input } from "./input-CJ_8EwcJ.js";
import { L as Label } from "./label-CK4Hn_cH.js";
import { S as Skeleton } from "./skeleton-EqcnD-ZK.js";
import { B as Badge } from "./badge-UvN_VHvW.js";
import { D as Dialog, b as DialogContent, c as DialogHeader, d as DialogTitle, e as DialogFooter } from "./dialog-iOFYvsS4.js";
import { S as Search } from "./search-BZBhpVMk.js";
import { R as RotateCw } from "./rotate-cw-hvWGDJhB.js";
import { P as Plus, T as Trash2 } from "./trash-2-hH4CWLkT.js";
import { D as Download } from "./download-CfP2a-V5.js";
import { M as MessageSquare } from "./message-square-D15dtMTt.js";
import { S as Scale } from "./scale-V_jfmlwQ.js";
import { C as Calendar } from "./calendar-C026_8sy.js";
import "node:async_hooks";
import "node:stream/web";
import "node:stream";
import "./index-BQjneAfj.js";
import "./Combination-DM-HIM0w.js";
...
async function generatePDF(t) {
  ...
  const metaFields = [{
    ...
    label: "STATUS",
    value: (t.invoice_status || "pending").toUpperCase()
  }, {
    label: "TRANSACTION",
    value: t.txn_number
  }];
  ...
  fn(7.5);
  st(CHAR);
  doc.text(t.notes || "No custom remarks recorded.", 20, totY + 18, {
    width: 80
  });
  sf(DARK);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3 items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full sm:max-w-xs", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Search transactions list...", value: search, onChange: (e) => setSearch(e.target.value), className: "pl-9 rounded-xl border border-border bg-card text-xs" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 w-full sm:w-auto justify-end items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", size: "sm", onClick: loadTransactions, disabled: loading, className: "rounded-xl cursor-pointer", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCw, { className: `h-3.5 w-3.5 ${loading ? "animate-spin" : ""}` }) }),
    ...
    !loading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden rounded-2xl border border-border/60 bg-card shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full border-collapse text-left text-xs", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { className: "divide-y divide-border", children: [
        transactions.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-muted/10 transition-colors", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4 text-right whitespace-nowrap", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: `rounded-full text-[10px] px-2 py-0.5 ${INVOICE_STATUS_COLORS[t.invoice_status] || "bg-gray-100"}`, children: (t.invoice_status || "pending").toUpperCase() }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4 text-right whitespace-nowrap", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-end gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", onClick: () => generatePDF(t), className: "h-7 w-7 rounded-lg text-muted-foreground hover:text-foreground cursor-pointer", title: "Download Invoice", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "h-4 w-4" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", onClick: () => handleWhatsApp(t), className: "h-7 w-7 rounded-lg text-muted-foreground hover:text-foreground cursor-pointer", title: "Simulate WhatsApp Send", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { className: "h-4 w-4" }) }),
            isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", onClick: () => handleDelete(t.id), className: "h-7 w-7 rounded-lg text-red-500 hover:text-red-600 hover:bg-red-50 cursor-pointer", title: "Delete Scale Ticket", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-4 w-4" }) })
          ] }) })
        ] }, t.id)),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { id: "txn-supplier", value: supplierId, onChange: (e) => setSupplierId(e.target.value), required: true, className: "w-full rounded-xl border border-border bg-background px-3 py-2.5 text-xs font-medium focus:outline-none focus:ring-1 focus:ring-primary", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { id: "txn-material", value: materialId, onChange: (e) => setMaterialId(e.target.value), required: true, className: "w-full rounded-xl border border-border bg-background px-3 py-2.5 text-xs font-medium focus:outline-none focus:ring-1 focus:ring-primary", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "txn-weight", type: "number", step: "0.001", value: weight, onChange: (e) => setWeight(e.target.value !== "" ? Number(e.target.value) : ""), placeholder: "0.000", required: true, className: "rounded-xl border border-border" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "txn-price", children: "Purchase Rate (₹/kg)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "txn-price", type: "number", step: "0.01", value: price, onChange: (e) => setPrice(e.target.value !== "" ? Number(e.target.value) : ""), placeholder: "₹ 0.00", required: true, className: "rounded-xl border border-border" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "txn-gst", children: "GST Rate (%)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { id: "txn-gst", value: gstRate, onChange: (e) => setGstRate(Number(e.target.value)), className: "w-full rounded-xl border border-border bg-background px-3 py-2.5 text-xs font-medium focus:outline-none focus:ring-1 focus:ring-primary", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 pt-1 border-t border-border/40", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", checked: immediatePayment, onChange: (e) => setImmediatePayment(e.target.checked), className: "h-4 w-4 accent-primary" })
          ] }),
          immediatePayment ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 animate-in slide-in-from-top-1 duration-150", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-2", children: ["cash", "upi", "bank_transfer", "cheque"].map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", variant: payMethod === m ? "default" : "outline", size: "sm", onClick: () => setPayMethod(m), className: "rounded-xl text-[10px] uppercase font-bold cursor-pointer", children: m.replace("_", " ") }, m)) })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "txn-due", type: "date", value: dueDate, onChange: (e) => setDueDate(e.target.value), className: "pl-9 rounded-xl border border-border text-xs" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "txn-notes", children: "Transaction Remarks" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "txn-notes", value: notes, onChange: (e) => setNotes(e.target.value), placeholder: "Scale calibrations, vehicle reference...", className: "rounded-xl border border-border" })
        ] }),
...
export {
  ERPTransactionsPage as component
};
