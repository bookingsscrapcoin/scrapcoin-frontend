import { ab as createLazyFileRoute, r as reactExports, ae as toast, L as jsxRuntimeExports, bc as Search, b7 as RotateCw, ay as Plus, bk as History, bh as Pen, az as Trash2 } from "./vendor-OkomiPNA.js";
import { u as useAuth, B as Button } from "./router--AfMktBh.js";
import { b as fetchERPMaterials, o as fetchERPMaterialPriceHistory, p as deleteERPMaterial, q as updateERPMaterial, r as createERPMaterial } from "./api-CEarRw-2.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 animate-in fade-in duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3 items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 w-full sm:w-auto justify-end items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex rounded-lg border border-border bg-muted/40 p-0.5", children: ["All", "Ferrous", "Non-Ferrous"].map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: () => setCategoryFilter(c),
            className: `rounded-md px-2.5 py-1 text-xs font-medium cursor-pointer transition-all ${categoryFilter === c ? "bg-background text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`,
            children: c
          },
          c
        )) }),
